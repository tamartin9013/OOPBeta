...
public abstract class Product implements Item, Comparable<Product> {
  ...
  /* Constructor that populates the product name, manufacturer, manufacturer date,
  * and serial number, which it increments.
  */
  public Product(String productName) {
    name = productName;
    serialNumber = currentProductionNumber;
    currentProductionNumber++; // FindBugs error write to static field.
    manufacturedOn = new Date();
  }

  // Sets currentProduction number to productionNumber.
  public void setProductionNumber(int productionNumber) {
    currentProductionNumber = productionNumber; // FindBugs error write to static field.
  }
  ...
  public Date getManufactureDate() {
    return manufacturedOn; // FindBugs error may expose internal representation
  }
